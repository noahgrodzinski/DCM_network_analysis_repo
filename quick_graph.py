...
sns.pairplot(dataset, y_vars=["h_index"], x_vars=[
    "average_coauthors",
...
second_order_collaborations_per_first_order_collaboration = dataset.second_order_connections/dataset.connections
